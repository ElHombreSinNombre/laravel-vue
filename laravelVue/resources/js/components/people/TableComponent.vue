                ...
                <div class="rounded-t px-4 py-3  bg-gray-200">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1 ">
                            ...
                            <h3 class="font-semibold text-lg "> <a href="/choose"
                                    class="cursor-pointer fas fa-arrow-circle-left hover:animate-bounce"></a>
                                People</h3>
                        </div>
                        <a href="/people/create"
                            class="text-right cursor-pointer fas fa-plus-circle hover:text-green-600 transition duration-500 ease-in-out"></a>
                        </div>
                    </div>
                    <div class="block w-full overflow-x-auto">
                        <table class="items-center w-full border-collapse  bg-gray-100">
                            ...
                            <tbody>
                                <tr class="">
                                    <td class="px-6 py-3 align-middle">Test</td>
                                    <td class="px-6 py-3 align-middle">Test</td>
                                    <td class="px-6 py-3 align-middle">Test</td>
                                    <td class="px-6 py-3 align-middle">Test</td>
                                    <td class="px-6 py-3 align-middle">Test</td>
